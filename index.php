...
<section id="introText">
  <div class="container">
    <div class="text-center adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      ...
      <p>The customer is very important, the customer will be followed by the customer. Sometimes it was a surprise and it didn't work. Tomorrow he needs to advertise that god's price is different. Tomorrow put a smile on the pain. The children's element of the ultricies, which is a lot of CNN's cartoons. The next payment will be made only by the Euismod employee. As a fear of the bow. </p>
    </div>
  </div>
</section>
<!--About-->
<section id="aboutUs" class="secPad">
  <div class="container">
    ...
    <div class="heading text-center adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      <!-- Heading -->
      <h2>About Us</h2>
      <p>But the Internet is available, but the majority have suffered alteration in some form by injected humour.</p>
    </div>
    <div class="row adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      ...
      <div class="col-md-8">
        <p>But in order that you may see whence all this born error of those who accuse pleasure and praise pain, all pain is loved, pursued, and sought to be obtained, but because such times never occur when he seeks some great pleasure through labor and pain. </p> 
        <p>But in order that you may see whence all this born error is the pleasure of those who accuse and praise pain, I will open the whole matter, and that very thing which is from that discoverer of truth, and as it were, who loves pain itself because it is pain, pursues it, wants to obtain it, but because such times never occur that with labor and pain he seeks some great pleasure. </p>  
      </div>
    </div>
  </div>   
</section>
